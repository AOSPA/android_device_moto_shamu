...
export DEVICE=shamu
export PROPRIETARY_FILES=device-proprietary-files.txt
...
function oat2dex()
{
    ...
    java -jar "$SMALIBASE/$BAKSMALIJAR" -x -o "$TMPDIR/dexout" -c boot.oat -d "$COPY_FROM/framework/arm" "$OAT"
